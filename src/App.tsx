          ...
          <div className="lg:col-span-5 relative flex items-end justify-center h-[500px] lg:h-auto">
            <AnimatePresence mode="wait">
              <motion.div key={hovered.id}
                ...
                <CharacterSprite mentor={hovered} isTalking={false} isStatic={true} className="w-full h-full object-contain object-bottom pixel-render drop-shadow-[0_0_80px_rgba(255,51,153,0.25)] scale-110" />
              </motion.div>
            </AnimatePresence>
